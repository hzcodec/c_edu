...
/* this function continously reads fd[0] for any input data
   byte if available, prints
*/ 
...
/* this function continously writes Capital Alphabet info fd[1]
...
/* this function continously writes small Alphabet info fd[1]
    waits if no more space is available
*/
void *writer_abc() {
    int result;
